IATI Standard SSOT - Standalone Build
=====================================

This is the README for managing a standalone website from this repo. As of June 2026 this is not an intended use of this repo and these instructions have not been tested but are preserved here for reference.
...
Building a website that also includes additional guidance
=========================================================

There is additional guidance in the following git repositories:
